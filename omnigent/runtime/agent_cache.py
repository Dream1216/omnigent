        ...
        *,
        ...
        if workdir.is_dir():
            try:
                ...
                # Older releases extracted directly into the public cache
                # path, so a crash could leave partial derived data behind.
                # Rebuild it from the ArtifactStore source of truth.
