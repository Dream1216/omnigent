...
def test_migration_and_runtime_share_one_canonical_fifteen_binding_profile() -> None:
...
def test_runner_agents_have_file_only_double_bound_independent_identities() -> None:
    ...
    assert "outside the canonical exact-fifteen service-role binding manifest" in " ".join(
        readme.split()
    )
