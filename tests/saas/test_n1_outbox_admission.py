...
def test_n1_roles_replay_p0s8_through_p0s14_reuse_exact_p0s7_rate_contracts() -> None:
    source = _roles_source()
    ...
    assert (
        ...
        "'p0s000000012', 'p0s000000013', 'p0s000000014' )" in normalized_constraint_contract
    )
