...
export function AgentHarnessPicker({
  ...
  // long roster doesn't crowd the recommended picks. On an empty server the
  // create action stays top-level so the first custom agent is discoverable;
  // once regular agents exist, creation stays in the customary submenu.
  ...
  return (
    <HarnessPicker
      ...
      trigger={{
        disabled: disabledLabel !== undefined || previewOnly || (!hasAgents && sandboxSelected),
