...
fail-closed candidate with `p0s000000013` and exactly
...
2. **Four-authority migration through P0S13 and roles.** Provide four distinct
   ...
   `p0s000000013`, the runtime and control-plane projections from
